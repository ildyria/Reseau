 ...
 * 
 */
@WebServiceClient(name = "CalcService", targetNamespace = "http://calc/", wsdlLocation = "http://cavalier:50042/myCalc/calc/eval?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCSERVICE_QNAME = new QName("http://calc/", "CalcService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://cavalier:50042/myCalc/calc/eval?wsdl");
    ...
    public Calc getCalcPort() {
        return super.getPort(new QName("http://calc/", "CalcPort"), Calc.class);
    }
    ...
    public Calc getCalcPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calc/", "CalcPort"), Calc.class, features);
    }
